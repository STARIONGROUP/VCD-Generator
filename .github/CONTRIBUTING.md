...
We would like to start with saying thank you for wanting to contribute to VCD-Generator codebase. We want to keep it as easy as possible to contribute changes that get things working in your environment. There are a few guidelines that we need contributors to follow so that we have a chance of keeping on top of things.
...
While you're working away in your branch it's quite possible that your upstream development (most likely the canonical VCD-Generator version) may be updated. If this happens you should:
...
- Use `this` when accessing instance members, e.g. `this.Name = "VCD-Generator";`.
